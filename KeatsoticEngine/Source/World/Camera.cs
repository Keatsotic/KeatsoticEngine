...
namespace KeatsoticEngine.Source
{
	static class Camera
	{
		...
		private static Rectangle VisibleArea()
		{
			...
			Vector2 tr = Vector2.Transform(new Vector2(ManageResolution.VirtualWidth, 0), inverseViewMatrix);
			Vector2 bl = Vector2.Transform(new Vector2(0, ManageResolution.VirtualHeight), inverseViewMatrix);
			Vector2 br = Vector2.Transform(new Vector2(ManageResolution.VirtualWidth, ManageResolution.VirtualHeight), inverseViewMatrix);
			...
			return new Rectangle((int)min.X, (int)min.Y, (int)(ManageResolution.VirtualWidth / zoom), (int)(ManageResolution.VirtualHeight / zoom));
		}
